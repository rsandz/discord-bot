...
class MessagingTools:
    ...
    def __init__(self):
        self._listeners: List[Union[Callable[[str], None], Callable[[str], Awaitable[None]]]] = []

    def add_message_listener(self, callback: Union[Callable[[str], None], Callable[[str], Awaitable[None]]]) -> None:
        self._listeners.append(callback)

    def remove_message_listener(self, callback: Union[Callable[[str], None], Callable[[str], Awaitable[None]]]) -> None:
        self._listeners.remove(callback)

    async def notify_all(self, session: Session, metrics_logger: MetricsLogger, message: str) -> None:
