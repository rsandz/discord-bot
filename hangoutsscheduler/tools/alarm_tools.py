...
class CreateAlarmInput(BaseModel):
    ...
    description: str = Field(
        ...,
        description="Description/instructions for the alarm. It should be actionable by you when the alarm triggers.",
    )
...
class ListAlarmsInput(BaseModel):
    include_past: bool = Field(
        default=False, description="Whether to include past alarms"
    )
