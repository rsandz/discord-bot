...
def setup_langchain_logging():
    ...
    file_handler = RotatingFileHandler(f'{LOGGING_DIR}/langchain.log', maxBytes=MAX_LOG_SIZE_BYTES, backupCount=5)
    file_handler.setFormatter(
        logging.Formatter(LANG_CHAIN_LOG_FORMAT)
    )
...
def setup_application_logging(is_verbose: bool, request_id_filter: RequestIdFilter):
    ...
    file_handler = RotatingFileHandler(f'{LOGGING_DIR}/application.log', maxBytes=MAX_LOG_SIZE_BYTES, backupCount=5)
    file_handler.setFormatter(
